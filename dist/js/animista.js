//$('.sizeImgindex').show().animate({ marginLeft: "0" }, 100).animate({ marginLeft: "3px" }, 300);


const typed  = new Typed ('.typed', {
    //strings: ['Toda la experiencia, herramientas e información para una mejor<br> elección de carrera universitaria en una sola aplicación.'],
